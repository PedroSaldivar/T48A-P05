...
Original file is located at
    https://colab.research.google.com/drive/1rgH6WDu-85XJuxnMcmE6H8I_xppUtgx1
...
precios_model_3 = np.array([39990, 41990, 43990, 45990, 47990])
precios_model_s = np.array([89990, 91990, 93990, 95990, 97990])
precios_model_x = np.array([99990, 101990, 103990, 105990, 107990])
precios_model_y = np.array([44990, 46990, 48990, 50990, 52990])

def regresion_lineal(x, y):
    # Calcular la pendiente (slope) y la ordenada al origen (intercept)
    n = len(x)
...
resultado_model_3 = regresion_lineal(años, precios_model_3)
resultado_model_s = regresion_lineal(años, precios_model_s)
resultado_model_x = regresion_lineal(años, precios_model_x)
resultado_model_y = regresion_lineal(años, precios_model_y)

# Imprimir los resultados
print("Model 3:", resultado_model_3)
print("Model S:", resultado_model_s)
print("Model X:", resultado_model_x)
print("Model Y:", resultado_model_y)
